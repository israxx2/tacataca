          ...
          <div class="modal-content">
            ...
            {!! Form::open(['route' => 'estudiante.posicion' , 'method' => 'POST']) !!}
                <div class="modal-body">
                    ...
                    <div class="checkbox">
                        <label for="delantero"><input type="radio" id="posicion1" name="posicion" value="DELANTERO" required>Delantero</label>
                    </div>
                    <div class="checkbox">
                        <label for="ambidiestro"><input type="radio" id="posicion2" name="posicion"value="AMBIDIESTRO">Ambidiestro</label>
                    </div>
                    <div class="checkbox">
                            <label for="defensa"><input type="radio" id="posicion3" name="posicion"value="DEFENSA">Defensa</label>
                    </div>
                </div>
